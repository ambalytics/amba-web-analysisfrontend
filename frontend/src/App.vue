        ...
        <div class="logo-link">
            <router-link to="/" class="logo p-d-flex p-ai-center">
                <svg width="50" height="50" xmlns="http://www.w3.org/2000/svg">
                    <g><rect fill="#0f6364" id="canvas_background" height="52" width="52" y="-1" x="-1"/></g>
                     <g>
                    <text xmlns="http://www.w3.org/2000/svg" style="font-family: 'Ubuntu', sans-serif;letter-spacing: -0.23em; font-weight: bolder; "
                          font-weight="bold" xml:space="preserve" text-anchor="start" id="svg_1"
                          fill="#ffffff" font-size="44" y="39" x="7">at</text>
                     </g>
                    </svg>
            </router-link>
        </div>
